/* ce fichier serve à créer notre serveur */
...
//on crée un serveur node et on lui passe notre application app comme arguement
const server = http.createServer(app) 

//un écouteur d'évènements est enregistré, consignant le port ou 
